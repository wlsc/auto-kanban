...
<Tip>
For detailed setup instructions and examples, see the [Auto Kanban MCP Server](/integrations/auto-kanban-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Auto Kanban project based on this description.
