...
description: "Configure MCP (Model Context Protocol) servers to enhance your coding agents within Auto Kanban with additional tools and capabilities."
---
...
Auto Kanban provides one-click installation for popular MCP servers. Click a card to insert a pre-configured MCP server into the JSON configuration.

<Frame>
<img src="/images/settings-beta-popular-mcp-servers.png" alt="Popular MCP servers including Auto Kanban, Context7, Playwright, Exa, Chrome DevTools, and Dev Manager" />
</Frame>
...
<Check>
These changes update the global configuration file of the coding agent and will persist even if you stop using Auto Kanban.
</Check>
</Step>
</Steps>
