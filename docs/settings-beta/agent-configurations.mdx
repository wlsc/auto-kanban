...
<Info>
Agent profiles are used throughout Auto Kanban wherever agents run: onboarding, default settings, attempt creation, and follow-ups. The default configuration appears pre-selected in the agent dropdown in the chat input.
</Info>
...
<Card title="Connecting MCP Servers" icon="server" href="/settings-beta/mcp-servers">
  Configure MCP servers within Auto Kanban for your coding agents
</Card>
