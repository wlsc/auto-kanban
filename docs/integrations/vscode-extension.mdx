...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=wlsc.auto-kanban">
...
3. Search for `@id:wlsc.auto-kanban`
4. Click **Install**
</Tab>
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/wlsc/auto-kanban">
...
**Solutions**:
- Verify the extension is installed by searching `@id:wlsc.auto-kanban` in Extensions
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `wlsc.auto-kanban`.
</Info>
