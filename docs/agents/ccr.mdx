...
icon: https://www.autokanban.dev/images/logos/claude.svg#"
---
...
## Authentication
Authenticate and configure CCR outside of Auto Kanban. Follow the instructions on the CCR GitHub repo:
...
## Configure Auto Kanban

Auto Kanban does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Auto Kanban

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Auto Kanban" />
</Frame>

## Using CCR in Auto Kanban
