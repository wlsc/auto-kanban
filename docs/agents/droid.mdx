...
icon: https://www.autokanban.dev/images/logos/factory-ai-logo-light.png
---
...
<Step title="Authenticate with Factory AI">
  To use Droid in Auto Kanban, you must first authenticate:
...
Droid supports several configuration options in Auto Kanban:
...
These options can be configured when creating agent configurations in Auto Kanban.
