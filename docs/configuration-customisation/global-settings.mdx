...
<Note>
A redesigned Settings experience is available in <Badge color="orange">Beta</Badge>. Access it from the Workspaces UI via the navbar or command bar. [Learn more →](/settings-beta)
</Note>
...
<Frame>
<img src="/images/vk-settings.png" alt="Auto Kanban global settings page showing theme options, agent configuration, and settings" />
</Frame>
...
<Frame>
<img src="/images/vk-editor-ssh.png" alt="Auto Kanban settings editor section showing ssh configuration options." />
</Frame>
