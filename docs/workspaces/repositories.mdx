...
When you add a repository to a workspace, Auto Kanban creates a **git worktree** - a separate working directory linked to your repository.
...
**Where worktrees are stored:** In the `.auto-kanban-workspaces` directory (configurable in Settings).
</Accordion>
