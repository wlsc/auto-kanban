...
| **Project icons** | Square buttons showing project abbreviations (e.g., "VI" for auto-kanban) |
...
<Tip>
You can also manage projects from **Settings** → **Remote Projects**. See [Remote Projects Settings](/settings-beta/remote-projects) for more details.
</Tip>
