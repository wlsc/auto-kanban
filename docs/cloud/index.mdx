---
title: "Auto Kanban Cloud"
description: "Collaborate with your team in real-time with Cloud features"
sidebarTitle: "Overview"
---

<Note>
Auto Kanban Cloud is currently in <Badge color="orange">Beta</Badge>. Features may change before stable release.
</Note>

## What is Auto Kanban Cloud?

**Auto Kanban Cloud** adds team collaboration to Auto Kanban. Your projects, issues, and progress sync to the cloud so your entire team stays in sync.
...
<Card title="Same Interface" icon="desktop">
  Cloud uses the same Auto Kanban interface you already know. No new tools to learn.
</Card>
</CardGroup>
...
<Info>
You can use both Local and Cloud projects in the same Auto Kanban installation. They appear in separate sections of the sidebar.
</Info>

## How It Works

1. **Run Auto Kanban** as usual with `npx auto-kanban`
...
Think of it as your company or team in Auto Kanban.
...
- Review code directly in Auto Kanban
- Track PR status

## Getting Started

<Steps>
<Step title="Run Auto Kanban">
  ```bash
  npx auto-kanban
  ```
</Step>
