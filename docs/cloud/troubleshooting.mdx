...
description: "Solutions for common issues with Auto Kanban Cloud"
---

This page covers common issues you might encounter with Auto Kanban Cloud and how to resolve them.
...
4. Return to Auto Kanban and sign in again
</Accordion>
...
3. Try a different browser
4. Restart Auto Kanban (`npx auto-kanban`)
</Accordion>
...
1. **Check existing issues:** [github.com/wlscdev/auto-kanban/issues](https://github.com/wlscdev/auto-kanban/issues)
...
<Card title="Report an Issue" icon="github" href="https://github.com/wlscdev/auto-kanban/issues/new">
