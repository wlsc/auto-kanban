...
pub fn get_auto_kanban_temp_dir() -> std::path::PathBuf {
    ...
    if cfg!(target_os = "macos") {
        ...
        // Windows and other platforms: use temp dir with auto-kanban subdirectory
        std::env::temp_dir().join(dir_name)
    }
}
...
mod tests {
    ...
    fn test_make_path_relative_macos_private_alias() {
        ...
        let worktree = "/var/folders/zz/abc123/T/auto-kanban-dev/worktrees/vk-test";
